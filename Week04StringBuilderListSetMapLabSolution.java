...
public class Week04StringBuilderListSetMapLabSolution {
	...
	public static void main(String[] args) {
		...
		// 1. Why would we use a StringBuilder instead of a String? Strings cannot be changed. They are immutable,
		// meaning the underlying object that's assigned to a variable can never be changed. When we concatenate
		// to a stringing, we're actually creating a new string in memory, which takes up space. A StringBuilder is
		// a mutable object that has an array of characters underneath that we can add/remove characters from. At 
		// the end of building our string, we can turn it into a string, not creating multiple objects, taking less 
		// space
		...
		//List<String> strings = Arrays.asList("Teresa", "Ron", "Matea", "Jordanz", "Matt");
		strings.add("Teresa");
		strings.add("Ron");
		strings.add("Matea");
		strings.add("Jordanz");
